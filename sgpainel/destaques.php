...
$query_usuario = "select dest.id,gru.grupo,dest.tipo from destaque dest inner join grupo gru on (gru.id = dest.id_news) order by dest.tipo ";
...
<div id="tabledata" class="section">
			...
			<table width="143" border="0" cellspacing="1" cellpadding="0">
              <tr>
                <td width="141" class="ico_success"> <a href="add_destaque.php">Novo Registro </a></td>
              </tr>
            </table>
		<table id="table">
			<thead>
		      ...
		      <tr>
				 ...
				 break;
				  ...
				  break;
				    ...
				    ?></td>
			      <td class="table_title" style="font-weight: bold"><span class="table_title" style="font-weight: bold"><?php echo $row_usuario['grupo']; ?> </span></td>
