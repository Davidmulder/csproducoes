...
<script language="JavaScript" type="text/javascript" src="ingrid/js/jquery.js"></script>
<script language="JavaScript" type="text/javascript" src="ingrid/js/jquery.ingrid.js"></script>
<link rel="stylesheet" href="ingrid/css/ingrid.css" type="text/css" media="screen" />
<script type="text/javascript" src="ingrid/js/jquery.cookie.js"></script>
