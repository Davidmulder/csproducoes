...
$query_usuario = "select new.id,are.titulo as area,new.titulo,new.data from news new inner join areas are on (are.id = new.id_area)  where id_area = '5'  order by id desc";
...
<div id="tabledata" class="section">
			<h2 class="ico_mug">Telefones</h2>
			
			<table width="200" border="0" cellspacing="1" cellpadding="0">
              <tr>
                <td class="ico_success"> <a href="add_new.php?area=5">Novo Registro </a></td>
              </tr>
            </table>
		<table id="table">
			<thead>
