...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO news (id_area, titulo, resumo, foto, `data`) VALUES (%s, %s, %s, %s, %s)",
		...
		<form action="<?php echo $editFormAction; ?>" method="POST" name="form" id="form" accept-charset="iso-8859-1">
			...
			<?php }?>
				  <table width="400" border="0" cellpadding="2" cellspacing="3" class="texto_formulario">
                    ...
                    <tr>
                      <td colspan="3"><input name="nome" type="text" class="form2" id="nome" size="70" /></td>
                    </tr>
                    <tr>
                      <td colspan="3">&nbsp;</td>
                    </tr>
                    ...
                    <tr>
                      <td colspan="3"><input name="resumo" type="text" class="form2" id="resumo" size="70" /></td>
                    </tr>
                    <tr>
