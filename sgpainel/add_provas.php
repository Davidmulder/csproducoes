		...
		<form action="<?php echo $editFormAction; ?>" method="POST" name="form" id="form" accept-charset="iso-8859-1">
			...
			<?php }?>
				  <table width="400" border="0" cellpadding="2" cellspacing="3" class="texto_formulario">
                    ...
                    <tr>
                      <td colspan="3"><input name="prova" type="text" class="form2" id="prova" size="70" /></td>
                    </tr>
                    <tr>
                      <td colspan="2">&nbsp;</td>
                      <td >&nbsp;</td>
                    ...
                    <tr>
                      <td colspan="3"><input name="gabarito" type="text" class="form2" id="gabarito" size="70" /></td>
                    </tr>
                    <tr>
                      <td colspan="2">&nbsp;</td>
                      <td >&nbsp;</td>
                    ...
                    <tr>
                      <td colspan="3"><input name="comentario" type="text" class="form2" id="comentario" size="70" /></td>
                    </tr>
                    <tr>
