...
<tr>
  ...
  <tr>
    <td height="400" valign="top" class="textmenu"><table width="300" border="0" bgcolor="#eaeaea" class="borda">
      <tr>
        <td height="15" class="texto_sis">:::add registro </td>
      </tr>
    </table>
            
		  <br>
		  <form name="form1" method="post" action="add_query.php">
		    <table width="400" border="0" cellspacing="2" class="texto">
              <tr>
                <td>Area</td>
                <td colspan="3">
                  <select name="varea" class="form" id="varea">
             ...
             <?php } while ($row_areas = pg_fetch_array($conn_areas)); ?>   
              ...
              <tr>
                ...
                <td colspan="3"><input name="titulo" type="text" class="form" id="titulo" size="50"></td>
              </tr>
              <tr>
                <td>Subtitulo</td>
                <td colspan="2"><input name="subtitulo" type="text" class="form" id="subtitulo" size="50" /></td>
              ...
              <tr>
                ...
                <td colspan="3"><input name="Submit" type="submit" class="botao" value="Gravar" />
                  <input name="data" type="hidden" id="data" value="<?php echo $data=date("m/d/y")." ".date("h:i:s") ?>" />
                  <input name="area" type="hidden" id="area" value="3" /></td>
              </tr>
            </table>
            </form>
		  </td>
