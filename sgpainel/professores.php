...
$query_usuario = "SELECT prof.id,prof.nome,disc.nome as materia FROM professores prof inner join ph_diciplina disc on (disc.id = prof.id_disc) ORDER BY prof.nome  ";
...
<div id="tabledata" class="section">
			<h2 class="ico_mug">Professores</h2>
			
			<table width="200" border="0" cellspacing="1" cellpadding="0">
              <tr>
                <td class="ico_success"><a href="add_prof.php">Novo Registro </a></td>
              </tr>
            </table>
			<table id="table">
			<thead>
			...
			<tbody>
		      ...
		      <tr>
				 ...
				 $vdata= $row_usuario['id']; 
				 echo $vdata;
				  ?></td>
			      <td class="table_title" style="font-weight: bold"><?php echo $row_usuario['nome']; ?></td>
			      <td class="table_title" style="font-weight: bold"><span class="table_title" style="font-weight: bold"><?php echo $row_usuario['materia']; ?> </span></td>
			      <td><a href="deletar.php?del=11&id=<?php echo $row_usuario['id']; ?>"><img src="img/cancel.jpg" alt="cancel" border="0"/></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="edit_prof.php?id=<?php echo $row_usuario['id']; ?>"><img src="img/edit.jpg" alt="edit" border="0"/></a></td>
		      </tr>
