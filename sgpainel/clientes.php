...
$query_usuario = "select id,nome,data,acesso,bairro,uf from cliente order by id desc ";
...
<div id="tabledata" class="section">
			...
			<tr>
				<th width="72">ID</th>
				<th width="116">Ultimo Acesso </th>
				<th width="211">Nome</th>
				<th width="186">Bairro</th>
				<th width="187">UF</th>
			...
			<tbody>
		      ...
		      <tr>
				 ...
				 $vdata= $row_usuario['data']; 
			      ...
			      <td class="table_title" style="font-weight: bold"><span class="table_title" style="font-weight: bold"><?php echo $row_usuario['bairro']; ?> </span></td>
