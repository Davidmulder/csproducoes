...
$query_usuario = "select * from tabela_valor ";
		...
		<table id="table">
			...
			<tbody>
		      ...
		      <tr>
			      ...
			      <td class="table_title" style="font-weight: bold"><span class="table_title" style="font-weight: bold"><?php echo $row_usuario['valor']; ?> </span></td>
