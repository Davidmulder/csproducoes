...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO pacotes (titulo, `local`, foto, resumo, texto, valor, parcela1, parcela2, parcela3, `data`) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
		...
		<form action="<?php echo $editFormAction; ?>" method="POST" name="form" id="form" accept-charset="iso-8859-1">
			...
			<?php }?>
				  <table width="400" border="0" cellpadding="2" cellspacing="3" class="texto_formulario">
                    ...
                    <tr>
                      <td colspan="3"><input name="local" type="text" class="form2" id="local" size="70" /></td>
                    </tr>
                    <tr>
                      <td colspan="3">&nbsp;</td>
                    </tr>
                    ...
                    <tr>
                      <td colspan="3"><input name="foto" type="text" class="form2" id="foto" size="70" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td colspan="3"><textarea name="resumo" cols="70" rows="4" class="form2" id="resumo"></textarea></td>
                    </tr>
                    <tr>
                      <td colspan="3">&nbsp;</td>
                    </tr>
                    ...
                    <tr>
                      <td colspan="3">R$ 
                        <input name="valor" type="text" class="form2" id="valor" size="10" /></td>
                    </tr>
                    <tr>
                      <td colspan="3">&nbsp;</td>
                    </tr>
                    ...
                    <tr>
                      <td colspan="3">1&ordm; 
                        <input name="pacela1" type="text" class="form2" id="pacela1" size="30" /></td>
                    </tr>
                    <tr>
                      <td colspan="3">2&ordm;
                      <input name="pacela2" type="text" class="form2" id="pacela2" size="30" /></td>
                    </tr>
                    <tr>
                      <td colspan="3">3&ordm;
                      <input name="pacela3" type="text" class="form2" id="pacela3" size="30" /></td>
                    </tr>
                    <tr>
                      <td colspan="3">&nbsp;</td>
                    </tr>
