...
$query_usuario = "select new.id,are.titulo as area,new.titulo,new.data from news new inner join areas are on (are.id = new.id_area) where id_area = '7' order by id desc";
...
<div id="tabledata" class="section">
			...
			<table width="200" border="0" cellspacing="1" cellpadding="0">
              <tr>
                <td class="ico_success"> <a href="add_parceiros.php?area=7">Novo Registro </a></td>
              </tr>
            </table>
		<table id="table">
			<thead>
			...
			<tbody>
		      ...
		      <tr>
				 ...
				 $vdata= $row_usuario['data']; 
			      ...
			      <td><a href="deletar.php?del=17&id=<?php echo $row_usuario['id']; ?>"><img src="img/cancel.jpg" alt="cancel" border="0"/></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="edit_parceiros.php?id=<?php echo $row_usuario['id']; ?>"><img src="img/edit.jpg" alt="edit" border="0"/></a></td>
		      </tr>
