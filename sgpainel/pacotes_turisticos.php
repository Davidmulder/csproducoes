...
$query_usuario = "select id,titulo,valor,local from pacotes order by id desc";
...
<div id="tabledata" class="section">
			...
			<table width="200" border="0" cellspacing="1" cellpadding="0">
              <tr>
                <td class="ico_success"> <a href="add_pacotes.php?area=<?php echo $_GET["area"]; ?>">Novo Registro </a></td>
              </tr>
            </table>
		<table id="table">
			<thead>
			<tr>
				...
				<th width="264">Titulo</th>
				<th width="193">Valor</th>
			...
			<tbody>
		      ...
		      <tr>
				 ...
				 echo $row_usuario['id']; 
				  ?></td>
			      <td class="table_title" style="font-weight: bold"><?php echo $row_usuario['local']; ?></td>
			      ...
			      <td class="table_title" style="font-weight: bold"><span class="table_title" style="font-weight: bold">R$ <?php echo $row_usuario['valor']; ?></span></td>
			      <td><a href="deletar.php?del=16&id=<?php echo $row_usuario['id']; ?>"><img src="img/cancel.jpg" alt="cancel" border="0"/></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="edit_pacotes.php?id=<?php echo $row_usuario['id']; ?>"><img src="img/edit.jpg" alt="edit" border="0"/></a></td>
		      </tr>
