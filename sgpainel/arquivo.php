...
$query_usuario = "select arq.id,arq.nome as titulo,prof.nome,arq.data from arquivo arq inner join professores prof on (prof.id = arq.id_prof) order by arq.id desc";
...
<div id="tabledata" class="section">
			<h2 class="ico_mug">Downloads de professor </h2>
			
			<table width="200" border="0" cellspacing="1" cellpadding="0">
              <tr>
                <td class="ico_success"> <a href="add_arquivo.php?area=1">Novo Registro </a></td>
              </tr>
            </table>
		<table id="table">
			<thead>
			<tr>
				<th width="38">&nbsp;</th>
				<th width="127">Data</th>
				<th width="278">Arquivo</th>
				<th width="331">Professor</th>
