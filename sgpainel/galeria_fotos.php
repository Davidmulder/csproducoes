...
$query_usuario = "select new.id,are.titulo as area,new.titulo,new.data,new.foto,new.resumo as arquivo from news new inner join areas are on (are.id = new.id_area)  where id_area = '2'  order by id desc";
...
<div id="tabledata" class="section">
			...
			<table width="200" border="0" cellspacing="1" cellpadding="0">
              <tr>
                <td class="ico_success"> <a href="add_mutimidia.php?area=2">Novo Registro </a></td>
              </tr>
            </table>
		<table id="table">
			<thead>
			...
			<tbody>
		      ...
		      <tr>
				 ...
				 $vdata= $row_usuario['data']; 
			      ...
			      <td align="center" class="table_title" style="font-weight: bold"><a href="ver_galeria.php?foto=<?php echo $row_usuario['arquivo']; ?>"><img src="img/ico_settings.png" width="16" height="16" border="0" /></a></td>
			      <td><a href="deletar.php?del=14&id=<?php echo $row_usuario['id']; ?>"><img src="img/cancel.jpg" alt="cancel" border="0"/></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="edit_mutimidia.php?id=<?php echo $row_usuario['id']; ?>"><img src="img/edit.jpg" alt="edit" border="0"/></a></td>
		      </tr>
